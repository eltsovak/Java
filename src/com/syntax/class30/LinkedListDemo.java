...
public class LinkedListDemo {
	...
	public static void main(String[] args) {
		...
		// System.out.println("LinkedList after Iterator = " + food); // --> removes all the food, makes it empty, we ate all the food
		System.out.println();
		System.out.println("LinkedList after Iterator = " + food);
		
		// let's create list list with Country type of Objects
